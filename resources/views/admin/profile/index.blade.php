    ...
    <div class="flex flex-col md:flex-row md:items-center gap-6">
        ...
        <div class="flex-1">
            ...
            <div class="flex flex-wrap gap-2 mt-3">
                <span class="px-3 py-1 rounded-full text-xs font-semibold bg-[#f5e6b3] text-[#7a5c12]">
                    ⭐ {{ ucwords(str_replace('_', ' ', optional($user->role)->nama_role ?? 'User')) }}
                </span>
                ...
                <span class="px-3 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300">
                    ● Active
                </span>
            </div>
        </div>
        <div class="text-right text-sm text-slate-500 dark:text-slate-400">
            <p>Member sejak</p>
            <p class="font-semibold text-slate-900 dark:text-white">{{ $user->created_at->format('d M Y') }}</p>
        </div>
    </div>
</div>
